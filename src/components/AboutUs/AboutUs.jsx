					...
					<div className="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
						...
						<div className="mb-4 lead">
							<ul className="about-us-list">
								...
								<li>
									<ImCheckmark className="about-us-checkmark" />Social Media Management
								</li>
								<li>
									<ImCheckmark className="about-us-checkmark" />Digital Marketing
								</li>
								<li>
									<ImCheckmark className="about-us-checkmark" />Graphic Design
								</li>
							</ul>
						</div>
					</div>
