		...
		<section id="services-section" data-aos="fade-up" data-aos-delay="100">
			...
			<Container className="services-carousel">
				...
				<div className="carousel-controls">
					<button className="btn btn-primary btn-lg rounded-0" onClick={decrementIndex}>
						<FaArrowLeft />
					</button>
					<button className="btn btn-primary btn-lg rounded-0" onClick={incrementIndex}>
						<FaArrowRight />
					</button>
				</div>
				<Carousel
				...
				>
					{content.map((c, i) => (
						<Carousel.Item key={i} className="services-carousel-text-item">
